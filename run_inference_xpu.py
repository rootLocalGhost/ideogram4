...
# Assuming you updated __init__.py to export the _xpu pipeline, 
# otherwise change to import from pipeline_ideogram4_xpu directly.
...
from ideogram4.pipeline_ideogram4_xpu import Ideogram4Pipeline
...
def main() -> None:
  ...
  if args.magic_prompt:
    ...
    magic = MAGIC_PROMPTS[args.magic_prompt_model](api_key=args.magic_prompt_key)  
    print(
